...
pacman -Rn --noconfirm simple-scan gnome-contacts snapshot gnome-user-docs yelp gnome-music gnome-user-share gnome-remote-desktop gnome-maps sushi gnome-text-editor showtime gvfs-wsdd gvfs-smb gvfs-onedrive gvfs-goa gvfs-nfs gvfs-dnssd gnome-weather gnome-tour loupe gnome-software epiphany orca decibels malcontent rygel baobab
